...
ggplot(gli1_expression_in_samples) + 
  ...
  geom_text(aes(0,3.123675,label = 'overexpression threshold  value = 3.1', vjust = -1), size=3,position= position_nudge(x=3.5, y=0), colour='royalblue4')
...
ggplot(gli1_expression_in_samples) +
  ...
  geom_text(aes(3.123675,0, label = 'overexpression threshold  value = 3.1'), position = position_nudge(x=-0.75, y=5.2), colour='royalblue4')
...
#  Plot ptch1 expression in synovial sarcoma samples
...
ggplot(ptch1_expression_in_samples) + 
  ...
  geom_text(aes(0,5.394524,label = 'overexpression threshold  value = 5.4', vjust = -1), size=3,position= position_nudge(x=3.5, y=-0.4), colour='royalblue4')
...
ggplot(ptch1_expression_in_samples) +
  ...
  geom_text(aes(5.394524,0, label = 'overexpression threshold  value = 5.4'), position = position_nudge(x=-0.85, y=5.2), colour='royalblue4')
...
ggplot(pdgfra_expression_in_samples) + 
  ...
  geom_text(aes(0,7.568913,label = 'overexpression threshold  value = 7.6', vjust = -1), size=3,position= position_nudge(x=3.8, y=-0.6), colour='royalblue4')
...
ggplot(pdgfra_expression_in_samples) +
  ...
  geom_text(aes(7.568913,0, label = 'overexpression threshold value = 7.6'), position = position_nudge(x=-1.2, y=5.2), colour='royalblue4')
